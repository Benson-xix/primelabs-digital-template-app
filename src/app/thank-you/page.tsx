        ...
        <div className="lg:col-start-2">
          ...
          {order._isPaid ? (
            <p className="mt-2 text-base text-muted-foreground">
              Your order was processed and your template assets are available to
          ...
          <div className="mt-16 text-sm font-medium">
            ...
            <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
              ...
              {order.customizeTemplate && (
                <div className="flex justify-between">
                  <p>Customize Template Fee</p>
                  <p className="text-gray-900">{formatPrice(30)}</p>
                </div>
              )}

              {order.hostingTemplate && (
                <div className="flex justify-between">
                  <p>Hosting Template Fee</p>
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                ...
                <p className="text-base">{formatPrice(orderTotal + 1 + (order.customizeTemplate ? 30 : 0) + (order.hostingTemplate ? 10 : 0))}</p>
              </div>
            </div>
