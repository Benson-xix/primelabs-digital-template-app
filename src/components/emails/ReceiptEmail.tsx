...
export const ReceiptEmail = ({
    ...
    const productTotal = products.reduce((acc, curr) => acc + curr.price, 0);
    const customizationFee = customizeTemplate ? 30 : 0;
    const hostingFee = hostingTemplate ? 10 : 0;
    const total = productTotal + customizationFee + hostingFee + 1; 
